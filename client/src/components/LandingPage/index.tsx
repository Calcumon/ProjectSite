...
const LandingPage: React.FC = () => {
    ...
    const LandingPageFeatureData: LandingPageFeatureProps[] = [
        {
            title: "Kids love it.",
            description: "The gamified experience excites kids as they solve math problems to rescue different calcumon creatures.",
            image: kidIcon,
            i: 0,
        },
        {
            title: "Together, we learn",
            description: "Kids feel motivated to play when competing with their friends using our multiplayer option!",
            image: multiPlayerIcon,
            i: 1,
        },
        {
            title: "Moniter Growth",
            description: "Parents recieve weekly progress updates and learning growth analytics for their child.",
            image: analyticsIcon,
            i: 2,
        },
        {
